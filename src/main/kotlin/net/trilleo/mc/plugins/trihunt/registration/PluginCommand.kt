 ...
 * (alias `/tb`). For example, a command with `name = "reload"` becomes
 * `/tribingo reload`. Set [isMainCommand] to `true` to register the command
 ...
 *     usage = "/tribingo start",
 *     permission = "tribingo.start"
 * ) {
